                ...
                <form action="/rc-setting/register/store-account" method="POST">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <div class="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
                            ...
                            />
                            <label
                                class="inline-block pl-[0.15rem] hover:cursor-pointer text-sm text-neutral-500"
                                for="exampleCheck">
                                <a href="#" class="text-blue-400 hover:underline">利用規約</a>
                                と
                                <a href="#" class="text-blue-400 hover:underline">プライバシーポリシー</a>
                                に同意しますか？
                            </label>
                        </div>
                </div>
                    ...
                    <button
                        type="submit"
                        class="inline-block w-full rounded bg-white px-7 pb-2.5 pt-3 text-sm font-bold uppercase leading-normal  shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] text-gray-600"
                        data-te-ripple-init
